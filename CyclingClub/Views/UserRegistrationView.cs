...
namespace CyclingClub.Views
{
    public class UserRegistrationView:IView
    {
        ...
        public void RunView()
        {
            ...
            _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.AdressCity] = GetInputFromUser(FieldConstants.UserRegistrationField.AdressCity, "Please enter the city where you live: ");
